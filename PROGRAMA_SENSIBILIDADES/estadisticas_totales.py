...
class Estadisticas:
    ...
    def hacer_tabla(self, nombre_archivo):
        ...
        with pd.ExcelWriter(nombre_archivo) as f:
...
resultados = estadisticas.hacer_tabla(input('¿Cómo quieres que se llame el archivo? Debes poner .xlsx al final'))
