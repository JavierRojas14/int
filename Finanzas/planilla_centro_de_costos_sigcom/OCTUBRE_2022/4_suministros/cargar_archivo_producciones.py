...
def cargar_archivo():
    ...
    df_hospitalizaciones = producciones.loc[0:2, mes_a_analizar]
    df_producciones = producciones.loc[3:, mes_a_analizar]

    return df_hospitalizaciones, df_producciones


if __name__ == '__main__':
    hospitalizaciones_mes, producciones_mes = cargar_archivo()
