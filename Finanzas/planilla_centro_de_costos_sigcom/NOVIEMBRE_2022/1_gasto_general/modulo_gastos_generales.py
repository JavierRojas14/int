...
class ModuloGastosGeneralesSIGCOM:
    ...
    def cargar_archivos_y_tratar_df(self):
        ...
        - Agrega la columna "TIPO GASTO SIGFE" a los dos primeros archivos. Además, los TIPO GASTO SIGFE
        están en formato str.
        '''
        print('- Cargando los archivos -')
        estado_ej_presup = pd.read_excel('input\\SA_EstadoEjecucionPresupuestaria_NOVIEMBRE.xls',
                                         header=6)
        ...
        disponibilidad_devengo['TIPO GASTO SIGFE'] = disponibilidad_devengo['Concepto Presupuestario'].str\
            .split().str[0]
    ...
    def obtener_excepciones_a_rrhh(self, facturas_a_analizar, estado_ej_presup):
        ...
        for codigo_sigfe_excepcion in EXCEPCIONES_SIGFE:
            ...
            mask_excepcion = (estado_ej_presup['TIPO GASTO SIGFE'] == codigo_sigfe_excepcion)
    ...
    def obtener_fondos_fijos(self, facturas_a_analizar, estado_ej_presup):
        ...
        suma_fondos_fijos = facturas_a_fondos_fijos.groupby('TIPO GASTO SIGFE').sum()
        ...
        for codigo_sigfe in suma_fondos_fijos.index:
            ...
            mask_fondo_fijo = (estado_ej_presup['TIPO GASTO SIGFE'] == codigo_sigfe)
    ...
    def rellenar_centros_de_costos(self, facturas_a_gg):
        ...
        for factura in facturas_no_rellenadas.itertuples():
            ...
            while True:
                centro_de_costo = input('¿Qué centro de costo crees que es? '
